...
gulp.task('start:myOSX', function() {
    //exec('/Users/Christophe/Projets/node-webkit/nwjs-sdk-v0.18.0-osx-x64/nwjs.app/Contents/MacOS/nwjs --enable-spell-checking /Users/Christophe/Projets/node-webkit/Natao/app',function(err) {
    exec('/Users/Christophe/Projets/node-webkit/nwjs-sdk-v0.18.0-osx-x64/nwjs.app/Contents/MacOS/nwjs /Users/Christophe/Projets/node-webkit/Natao/app',function(err) {
        if (err) {
            console.error(err);
        }
    });
