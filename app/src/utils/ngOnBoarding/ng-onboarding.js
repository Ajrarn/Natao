        ...
        'ngOnboardingDefaults', '$sce', '$timeout', function(ngOnboardingDefaults, $sce, $timeout) {
            return {
                ...
                link: function(scope, element, attrs) {
                    var attributesToClear, curStep, setupOverlay, setupPositioning,options;
                    options = {};
                    curStep = null;
                    ...
                    scope.$watch('index', function(newVal, oldVal) {
                        ...
                        angular.copy(ngOnboardingDefaults,options);
                        if (scope.customOptions) {
                            for (k in scope.customOptions) {
                                options[k] = scope.customOptions[k];
                            }
                        }
