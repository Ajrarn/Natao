...
Mon fils est dyspraxique et on m'a demandé de lui fournir des modèles de documents Word, pour lui faciliter l'usage de l'ordinateur en classe. Et oui, si beaucoup pensent que c'est super cool d'utiliser un ordinateur en classe, je me dis que ce n'est pas aussi simple que ça en a l'air. Et pourtant, ça le devrait.

Mais qu'est-ce qui ne va pas ?

## L'explorateur de fichiers
Un élève utilsant un ordinateur, doit classer ses documents dans des dossiers, dans une fenêtre *Explorateur de fichier* et les ouvrir dans une fenêtre à part *Traitement de texte*. Pour passer d'un document à un autre, il peut soit revenir sur la fenêtre *Explorateur de fichier*, soit aller explorer le menu du *Traitement de texte* pour aller ouvrir un document en ouvrant une mini fenêtre *Explorateur de fichier*.
...
Voila pourquoi Natao inclut cette fonctionnalité essentielle. Mais du coup, pourquoi ne pas l'enrichir. Imaginons que cet *Explorateur de documents* puisse faciliter le rangement de ceux-ci.

C'est pourquoi il intègre 2 fonctionnalités supplémentaires:
- La possibilité de colorer les titres de dossiers là, c'est juste un repère visuel).
...
Là, où le bat blesse, c'est qu'il est parfois assez difficile de faire sa propre mise en forme.

Inaccessible pour la plupart des adultes, alors pour un enfant...

### HTML / CSS
Actuellement un des meilleurs exemples de la séparation de la forme et du contenu. Le HTML, c'est le contenu, et le CSS l'habille. Et le CSS permet vraiment de faire des choses superbes. Malheureusement, ici c'est le HTML qui n'est pas aisé à écrire.
